            ...
            children: [
              Padding(
                ...
                child: GestureDetector(
                  onTap: (){navigateTo(context, showscheduleprosplit(exercise: shoulder1,));},
              ...
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: GestureDetector(
                  onTap: (){navigateTo(context, showscheduleprosplit(exercise: shoulder2,));},
              ...
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: GestureDetector(
                  onTap: (){navigateTo(context, showscheduleprosplit(exercise: shoulder3,));},
              ...
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: GestureDetector(
                  onTap: (){navigateTo(context, showscheduleprosplit(exercise: shoulder4,));},
              ...
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: GestureDetector(
                  onTap: (){navigateTo(context, showscheduleprosplit(exercise: shoulder5,));},
