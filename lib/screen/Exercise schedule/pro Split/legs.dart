            ...
            children: [
              Padding(
                ...
                child: GestureDetector(
                  onTap: (){navigateTo(context, showscheduleprosplit(exercise: leg1,));},
              ...
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: GestureDetector(
                  onTap: (){navigateTo(context, showscheduleprosplit(exercise: leg2,));},
              ...
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: GestureDetector(
                  onTap: (){navigateTo(context, showscheduleprosplit(exercise: leg3,));},
              ...
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: GestureDetector(
                  onTap: (){navigateTo(context, showscheduleprosplit(exercise: leg4,));},
              ...
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: GestureDetector(
                  onTap: (){navigateTo(context, showscheduleprosplit(exercise: leg5,));},
