...
class backAndBicep extends StatelessWidget {
  const backAndBicep({Key? key}) : super(key: key);
            ...
            children: [
              Padding(
                ...
                child: GestureDetector(
                  onTap: (){navigateTo(context, showscheduleprosplit(exercise:back1,));},
              ...
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: GestureDetector(
                  onTap: (){navigateTo(context, showscheduleprosplit(exercise: back2,));},
              ...
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: GestureDetector(
                  onTap: (){navigateTo(context, showscheduleprosplit(exercise: back3,));},
              ...
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: GestureDetector(
                  onTap: (){navigateTo(context, showscheduleprosplit(exercise: back4,));},
              ...
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: GestureDetector(
                  onTap: (){navigateTo(context, showscheduleprosplit(exercise: back5,));},
