...
import '../show schedule pro split.dart';
import '../show schedule.dart';

class chestAndTri extends StatelessWidget {
  const chestAndTri({Key? key}) : super(key: key);
            ...
            children: [
              Padding(
                ...
                child: GestureDetector(
                  onTap: (){navigateTo(context, showscheduleprosplit(exercise: chest5,));},
              ...
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: GestureDetector(
                  onTap: (){navigateTo(context, showscheduleprosplit(exercise: chest1,));},
              ...
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: GestureDetector(
                  onTap: (){navigateTo(context, showscheduleprosplit(exercise: chest2,));},
              ...
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: GestureDetector(
                  onTap: (){navigateTo(context, showscheduleprosplit(exercise: chest3,));},
              ...
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: GestureDetector(
                  onTap: (){navigateTo(context, showscheduleprosplit(exercise: chest4,));},
