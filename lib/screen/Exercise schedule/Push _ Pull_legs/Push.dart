...
class PushSchedule extends StatelessWidget {
  const PushSchedule({Key? key}) : super(key: key);
            ...
            children: [
              Padding(
                ...
                child: GestureDetector(
                  onTap: (){navigateTo(context, showSchedule(exercise: PushExercise1,));},
                      ...
                      children: [
                        ...
                        Positioned(
                          ...
                          child: Row(
                            ...
                            children: [
                              BuildText(text: 'Schedule 2' , color: Colors.yellow[400], bold: true,size: 35,),
                    ...
                    child: Stack(
                      children: [
                        ...
                        Positioned(
                          ...
                          child: Column(
                            children: [
                              BuildText(text: 'Schedule 3' , color: Colors.yellow[400], bold: true,size: 35,),
              ...
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: GestureDetector(
                  onTap: (){navigateTo(context, showSchedule(exercise: PushExercise4,));},
                    ...
                    child: Stack(
                      children: [
                        ...
                        Positioned(
                          ...
                          child: Column(
                            children: [
                              BuildText(text: 'Schedule 4' , color: Colors.yellow[400], bold: true,size: 35,),
              ...
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: GestureDetector(
                  onTap: (){navigateTo(context, showSchedule(exercise: PushExercise5,));},
                    ...
                    child: Stack(
                      children: [
                        ...
                        Positioned(
                          ...
                          child: Column(
                            children: [
                              BuildText(text: 'Schedule 5' , color: Colors.yellow[400], bold: true,size: 35,),
