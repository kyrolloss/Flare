...
class lats extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<AppCubit, AppState>(
      ...
      builder: (context, state) {
        ...
        var latsExercises = backModel
            .where((exercise) => exercise.targetMuscle == 'Latissimus Dorsi')
            .toList();
        return SafeArea(
          child: Scaffold(
                  ...
                  children: [
                    ...
                    SizedBox(
                        ...
                        child: GridView.builder(
                          itemCount: latsExercises.length,

                          gridDelegate:const SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 2),

                          itemBuilder: (context, index) {
                            return GestureDetector(
                              onTap: (){navigateTo(context, ExerciseDetailsPage(exercise: latsExercises[index]));},
                              child: Padding(
                                padding: const EdgeInsets.all(8.0),
                                child: Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(
                                          ...
                                          ,child: Image.asset('images/${latsExercises[index].gif}',fit: BoxFit.cover)),
                                      Padding(
                                        padding: const EdgeInsets.all(8.0),
                                        child: BuildText(text: latsExercises[index].name , color: Colors.black,),
                                      )
