...
class Lumbar extends StatelessWidget {
  const Lumbar({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<AppCubit, AppState>(
      ...
      builder: (context, state) {
        ...
        var lumbarExercises = backModel
            .where((exercise) => exercise.targetMuscle == 'Lumbar')
            .toList();
                  ...
                  children: [
                    ...
                    SizedBox(
                        ...
                        child: GridView.builder(
                          itemCount: lumbarExercises.length,

                          gridDelegate:const SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 2),

                          itemBuilder: (context, index) {
                            return GestureDetector(
                              onTap: (){navigateTo(context, ExerciseDetailsPage(exercise: lumbarExercises[index]));},
                              child: Padding(
                                padding: const EdgeInsets.all(8.0),
                                child: Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(
                                          ...
                                          ,child: Image.asset('images/${lumbarExercises[index].gif}',fit: BoxFit.cover)),
                                      Padding(
                                        padding: const EdgeInsets.all(8.0),
                                        child: BuildText(text: lumbarExercises[index].name , color: Colors.black,),
                                      )
