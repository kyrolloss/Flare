  ...
  Widget build(BuildContext context) {
    return BlocConsumer<AppCubit, AppState>(
      ...
      builder: (context, state) {
        ...
        var QuadricepsExercises = leg
            .where((exercise) => exercise.targetMuscle == 'Quadriceps')
            .toList();
                  ...
                  children: [
                    ...
                    SizedBox(
                        ...
                        child: GridView.builder(
                          itemCount: QuadricepsExercises.length,

                          gridDelegate:const SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 2),

                          itemBuilder: (context, index) {
                            return GestureDetector(
                              onTap: (){navigateTo(context, ExerciseDetailsPage(exercise: QuadricepsExercises[index]));},
                              child: Padding(
                                padding: const EdgeInsets.all(8.0),
                                child: Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(
                                          ...
                                          ,child: Image.asset('images/${QuadricepsExercises[index].gif}',fit: BoxFit.cover)),
                                      Padding(
                                        padding: const EdgeInsets.all(8.0),
                                        child: BuildText(text: QuadricepsExercises[index].name , color: Colors.black,),
                                      )
