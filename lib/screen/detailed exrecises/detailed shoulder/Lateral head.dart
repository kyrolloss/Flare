...
Widget build(BuildContext context) {
  return BlocConsumer<AppCubit, AppState>(
    ...
    builder: (context, state) {
      ...
      var lateralHeadExercises = shoulderModel
          .where((exercise) => exercise.targetMuscle == 'Lateral Deltoid')
          .toList();
                  ...
                  children: [
                    ...
                    SizedBox(
                        ...
                        child: GridView.builder(
                          itemCount: lateralHeadExercises.length,

                          gridDelegate:const SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 2),

                          itemBuilder: (context, index) {
                            return GestureDetector(
                              onTap: (){navigateTo(context, ExerciseDetailsPage(exercise: lateralHeadExercises[index]));},
                              child: Padding(
                                padding: const EdgeInsets.all(8.0),
                                child: Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(
                                          ...
                                          ,child: Image.asset('images/${lateralHeadExercises[index].gif}',fit: BoxFit.cover)),
                                      Padding(
                                        padding: const EdgeInsets.all(8.0),
                                        child: BuildText(text: lateralHeadExercises[index].name , color: Colors.black,),
                                      )
