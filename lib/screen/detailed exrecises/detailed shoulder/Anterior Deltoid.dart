...
class Anterior extends StatelessWidget {
  const Anterior({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<AppCubit, AppState>(
      ...
      builder: (context, state) {
        ...
        var anteriorExercises = shoulderModel
            .where((exercise) => exercise.targetMuscle == 'Anterior Deltoid')
            .toList();
                  ...
                  children: [
                    ...
                    SizedBox(
                        ...
                        child: GridView.builder(
                          itemCount: anteriorExercises.length,

                          gridDelegate:const SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 2),

                          itemBuilder: (context, index) {
                            return GestureDetector(
                              onTap: (){navigateTo(context, ExerciseDetailsPage(exercise: anteriorExercises[index]));},
                              child: Padding(
                                padding: const EdgeInsets.all(8.0),
                                child: Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(
                                          ...
                                          ,child: Image.asset('images/${anteriorExercises[index].gif}',fit: BoxFit.cover)),
                                      Padding(
                                        padding: const EdgeInsets.all(8.0),
                                        child: BuildText(text: anteriorExercises[index].name , color: Colors.black,),
                                      )
