  ...
  Widget build(BuildContext context) {
    return BlocConsumer<AppCubit, AppState>(
      ...
      builder: (context, state) {
        ...
        var tricepsExercises = tricepsModel
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(
                                          ...
                                          ,child: Image.asset('images/${tricepsExercises[index].gif}',fit: BoxFit.cover)),
                                      Padding(
                                        padding: const EdgeInsets.all(8.0),
                                        child: BuildText(text: tricepsExercises[index].name , color: Colors.black,),
                                      )
