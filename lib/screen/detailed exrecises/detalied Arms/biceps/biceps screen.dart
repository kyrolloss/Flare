  ...
  Widget build(BuildContext context) {
    return BlocConsumer<AppCubit, AppState>(
      ...
      builder: (context, state) {
        ...
        var bicepsExercises =bicepsModel
            .where((exercise) => exercise.targetMuscle == 'Biceps Brachii (Short Head)' || exercise.targetMuscle == 'Biceps Brachii'|| exercise.targetMuscle == 'Biceps (Long Head))')
            .toList();
                          ...
                          itemBuilder: (context, index) {
                            return Padding(
                              ...
                              child: GestureDetector(
                                onTap: (){navigateTo(context, ExerciseDetailsPage(exercise: bicepsExercises[index]));},
                                child: Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(
                                          ...
                                          ,child: Image.asset('images/${bicepsExercises[index].gif}',fit: BoxFit.cover)),
                                      Padding(
                                        padding: const EdgeInsets.all(8.0),
                                        child: BuildText(text: bicepsExercises[index].name , color: Colors.black,),
                                      )
